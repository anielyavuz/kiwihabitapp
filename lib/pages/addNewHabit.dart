                                ...
                                Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: RawMaterialButton(
                                            ...
                                            onPressed: _slidingCountADay <= 1
                                                ? null
                                                : () {
                                                    if (_slidingCountADay > 1) {
                                                      setState(() {
                                                        _slidingCountADay--;
                                    ...
                                    Container(
                                      ...
                                      child: Text(_slidingCountADay.toString(),
                            ...
                            children:
                              ...
                              return Container(
                                ...
                                child: RawMaterialButton(
                                    ...
                                    child: Text(
                                        DateFormat('E').format(
                                            DateTime(2000, 1, 3).add(Duration(
                            ...
                            child: CheckboxListTile(
                              ...
                              onChanged: (val) {
                                if (!_slidingCheckBoxEveryDay) {
                                  setState(() {
                                    _slidingCheckBoxEveryDay = true;
                                    for (var day in _slidingItemWeekDaysList) {
                                      setState(() {
                                        day['value'] = true;
                                      });
                                    }
